...
st.set_page_config(layout="centered", page_title="Question & Answer from your file")
st.header("Chatting QA for MOC")
st.write("---")
  
#file uploader
uploaded_files = st.file_uploader("Upload documents",accept_multiple_files=True, type=["doc","txt","pdf"])
st.write("---")
